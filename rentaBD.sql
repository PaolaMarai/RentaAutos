...
CREATE TABLE IF NOT EXISTS `mydb`.`Clientes` (
  ...
  CONSTRAINT `fk_Cliente_Usuario1`
    ...
    REFERENCES `mydb`.`Usuarios` (`correoUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_Cliente_Usuario1_idx` ON `mydb`.`Clientes` (`Usuario_correoUsuario` ASC);

CREATE UNIQUE INDEX `Usuario_correoUsuario_UNIQUE` ON `mydb`.`Clientes` (`Usuario_correoUsuario` ASC);
...
CREATE TABLE IF NOT EXISTS `mydb`.`Pedido` (
  ...
  CONSTRAINT `fk_Pedido_Cliente1`
    ...
    REFERENCES `mydb`.`Clientes` (`rfc` , `Usuario_correoUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Telefonos` (
  ...
  `Clientes_Usuario_correoUsuario` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`idTelefonos`, `Clientes_rfc`, `Clientes_Usuario_correoUsuario`),
  CONSTRAINT `fk_Telefonos_Clientes1`
    FOREIGN KEY (`Clientes_rfc` , `Clientes_Usuario_correoUsuario`)
    REFERENCES `mydb`.`Clientes` (`rfc` , `Usuario_correoUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE UNIQUE INDEX `numeroTelefono_UNIQUE` ON `mydb`.`Telefonos` (`numeroTelefono` ASC);

CREATE INDEX `fk_Telefonos_Clientes1_idx` ON `mydb`.`Telefonos` (`Clientes_rfc` ASC, `Clientes_Usuario_correoUsuario` ASC);
