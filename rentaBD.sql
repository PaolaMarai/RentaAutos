...
CREATE UNIQUE INDEX `iva_UNIQUE` ON `rentabd`.`Pedidos` (`iva` ASC);
...
CREATE UNIQUE INDEX `numeroTelefono_UNIQUE` ON `rentabd`.`Telefonos` (`numeroTelefono` ASC);
