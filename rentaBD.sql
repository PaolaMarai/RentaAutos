...
CREATE TABLE IF NOT EXISTS `rentabd`.`Vehiculos` (
  ...
  `modelo` VARCHAR(10) BINARY NOT NULL,
...
-- -----------------------------------------------------
-- Table `rentabd`.`Vehiculos_has_Pedidos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rentabd`.`Vehiculos_has_Pedidos` (
  `Vehiculos_numMotor` INT NOT NULL,
  `Pedidos_nomPedido` INT NOT NULL,
  PRIMARY KEY (`Vehiculos_numMotor`, `Pedidos_nomPedido`),
  CONSTRAINT `fk_Vehiculos_has_Pedidos_Vehiculos1`
    FOREIGN KEY (`Vehiculos_numMotor`)
    REFERENCES `rentabd`.`Vehiculos` (`numMotor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Vehiculos_has_Pedidos_Pedidos1`
...
CREATE INDEX `fk_Vehiculos_has_Pedidos_Pedidos1_idx` ON `rentabd`.`Vehiculos_has_Pedidos` (`Pedidos_nomPedido` ASC);

CREATE INDEX `fk_Vehiculos_has_Pedidos_Vehiculos1_idx` ON `rentabd`.`Vehiculos_has_Pedidos` (`Vehiculos_numMotor` ASC);
