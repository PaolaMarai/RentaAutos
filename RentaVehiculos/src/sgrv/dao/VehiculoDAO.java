...
public class VehiculoDAO implements IVehiculoDAO{
    ...
    public List<Vehiculo> obtenerTodos() {
        ...
        try {
            ...
            while(result.next()){
                Vehiculo vehiculo = new Vehiculo(result.getInt("numMotor"), result.getString("tipo"), result.getString("marca"), result.getString("color"), result.getString("modelo"), result.getInt("numPasajeos"), result.getFloat("precio"),result.getString("direccion"));
